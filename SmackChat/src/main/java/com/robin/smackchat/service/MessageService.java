package com.robin.smackchat.service;
...
import com.robin.smackchat.databases.ChatContract.ChatMessageTable;
...
import com.robin.smackchat.databases.ChatContract.ConversationTable;
...
import com.robin.smackchat.databases.ConversationTableHelper;
import com.robin.smackchat.model.SubscribeInfo;
import com.robin.smackchat.providers.DatabaseContentProvider;
import com.robin.smackchat.receivers.NetworkReceiver;
import com.robin.smackchat.utils.NotificationUtils;
import com.robin.smackchat.utils.PreferenceUtils;
import com.robin.smackchat.utils.ProviderUtils;
import com.robin.smackchat.xmpp.PresencePacketListener;
...
public class MessageService extends Service {
    ...
    public static final String EXTRA_DATA_NAME_FROM_NICKNAME = "com.robin.letschat.FromNickname";
    public static final String EXTRA_DATA_NAME_NOTIFICATION_TEXT = "com.robin.letschat.NotificationText";
    public static final String EXTRA_DATA_NAME_FROM = "com.robin.letschat.From";
    public static final String EXTRA_DATA_NAME_MESSAGE_BODY = "com.robin.letschat.MessageBody";
    public static final String EXTRA_DATA_NAME_LOCATION = "com.robin.letschat.Location";
    public static final String EXTRA_DATA_NAME_TYPE = "com.robin.letschat.Type";
    public static final String EXTRA_DATA_NAME_FILE_PATH = "com.robin.letschat.FilePath";
    // Service Actions
    public static final String ACTION_CONNECT = "com.robin.letschat.intent.action.CONNECT";
    public static final String ACTION_RECONNECT = "com.robin.letschat.intent.action.RECONNECT";
    public static final String ACTION_MESSAGE_RECEIVED = "com.robin.letschat.intent.action.MESSAGE_RECEIVED";
    public static final String ACTION_PRESENCE_RECEIVED = "com.robin.letschat.intent.action.PRESENCE_RECEIVED";
    public static final String ACTION_NETWORK_STATUS = "com.robin.letschat.intent.action.NETWORK_STATUS";
    // Broadcast Actions
    public static final String ACTION_CONTACT_REQUEST_RECEIVED = "com.robin.letschat.intent.action.CONTACT_REQUEST_RECEIVED";
