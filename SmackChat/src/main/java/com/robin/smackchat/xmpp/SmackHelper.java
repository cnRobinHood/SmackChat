...
import com.robin.smackchat.utils.FileUtils;
import com.robin.smackchat.utils.NetworkUtils;
...
public class SmackHelper {
    ...
    public static final String ACTION_CONNECTION_CHANGED = "com.robin.letschat.intent.action.CONNECTION_CHANGED";
    public static final String EXTRA_NAME_STATE = "com.robin.letschat.State";
